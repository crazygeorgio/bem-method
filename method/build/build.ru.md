...
Описывая декларацию, можно изменять состав получаемых бандлов, точечно определяя необходимые для проекта БЭМ-сущности. Это избавляет от ненужного кода, который значительно увеличивает объем бандлов.
...
Описывая зависимости, можно строить новые блоки на основе уже существующих. Это избавляет от ненужного «Copy-Paste».
...
Используя уровни переопределения, можно изменять представление и поведение блоков для различных платформ.
